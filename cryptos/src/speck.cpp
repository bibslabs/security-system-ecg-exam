...
uint8_t Speck_Init(SimSpk_Cipher *cipher_object, enum cipher_config_t cipher_cfg, enum mode c_mode, void *key, uint8_t *iv, uint8_t *counter) {
...
uint8_t Speck_Encrypt(SimSpk_Cipher cipher_object, const uint8_t *plaintext, uint8_t *ciphertext) {
...
uint8_t Speck_Decrypt(SimSpk_Cipher cipher_object, const uint8_t *ciphertext, uint8_t *plaintext) {
